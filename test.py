...
def parse_arguments():
    ...
    parser.add_argument("--TFN_hidden_dims", type=list, default=[62,204,74], # 314,1023,367
    ...
    parser.add_argument("--TFN_post_fusion_dim", type=int, default=64, 
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('checkpoints/ckp_TFN_epoch30.pt'))
